...
namespace MovieStoreMvc.Repositories.Implementation
{
    public class MovieService : IMovieService
    {
        ...
        public bool AddToCart(Movie model)
        {
            try
            {
        ...
        public CartListVm CartList(string term="",bool paging=false, int currentPage=0)
        {
            var data = new CartListVm();
            ...
            data.CartList = list.AsQueryable();
            return data;
        }
